...
biggerOne.addEventListener("mouseover", (event) => {
	...
	biggerOne.style.width = "360px";
	biggerOne.style.height = "360px";
	}
});
biggerOne.addEventListener("mouseout", () => {
	biggerOne.style.width = "350px";
	biggerOne.style.height = "350px";
});

biggerTwo.addEventListener("mouseover", (event) => {
	if (event.target.id == "biggerTwo") {
		biggerTwo.style.width = "360px";
		biggerTwo.style.height = "360px";
	}
});
biggerTwo.addEventListener("mouseout", () => {
	biggerTwo.style.width = "350px";
	biggerTwo.style.height = "350px";
});

biggerThree.addEventListener("mouseover", (event) => {
	if (event.target.id == "biggerThree") {
	biggerThree.style.width = "360px";
	biggerThree.style.height = "360px";
	}
});
biggerThree.addEventListener("mouseout", () => {
	biggerThree.style.width = "350px";
	biggerThree.style.height = "350px";
});

biggerFour.addEventListener("mouseover", (event) => {
	if (event.target.id == "biggerFour") {
	biggerFour.style.width = "360px";
	biggerFour.style.height = "360px";
	}
});
biggerFour.addEventListener("mouseout", () => {
	biggerFour.style.width = "350px";
	biggerFour.style.height = "350px";
});

biggerFive.addEventListener("mouseover", (event) => {
	if (event.target.id == "biggerFive") {
	biggerFive.style.width = "360px";
	biggerFive.style.height = "360px";
	}
});
biggerFive.addEventListener("mouseout", () => {
	biggerFive.style.width = "350px";
	biggerFive.style.height = "350px";
});

biggerSix.addEventListener("mouseover", (event) => {
	if (event.target.id == "biggerSix") {
	biggerSix.style.width = "360px";
	biggerSix.style.height = "360px";
	}
});
biggerSix.addEventListener("mouseout", () => {
	biggerSix.style.width = "350px";
	biggerSix.style.height = "350px";
});
